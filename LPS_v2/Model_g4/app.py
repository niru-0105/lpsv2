...
def handle_application():
    ...
    # print("json_data['earliestCrLine']: ",json_data['earliestCrLine'])
    # return json_data
    if json_data['earliestCrLine'] is not None:
        ...
        try:
            ...
            json_data['earliestCrLine'] = datetime.strptime(date_parts, '%Y-%m-%d %H:%M:%S').strftime('%Y-%m-%d %H:%M:%S')
            print(json_data['earliestCrLine'])
